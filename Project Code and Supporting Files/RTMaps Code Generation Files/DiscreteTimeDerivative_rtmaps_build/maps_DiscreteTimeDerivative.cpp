...
#include "maps_DiscreteTimeDerivative.h"
...
void ComponentClass::computeSkModelInputs()
{
  ...
  m_skModelInputs.emplace_back(
    ...
    &DiscreteTimeDerivative_U.DerivativeInput,
...
void ComponentClass::computeSkModelOutputs()
{
  ...
  const ExtY_DiscreteTimeDerivative_T &DiscreteTimeDerivative_Y =
    DiscreteTimeDerivative_Obj.getExternalOutputs();
  m_skModelOutputs.emplace_back(
    ...
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &DiscreteTimeDerivative_Y.DerivativeOutput,
...
void ComponentClass::computeSkModelProps()
{
  ...
  P_DiscreteTimeDerivative_T &DiscreteTimeDerivative_P =
    DiscreteTimeDerivative_Obj.DiscreteTimeDerivative_P;
  m_skModelParams.emplace_back(
    "DiscreteDerivative_ICPrevScaled",
    0,
    1,
    SkTypeId::t_double,
    "0.0",
...
{
  DiscreteTimeDerivative_Obj.initialize();
}

void ComponentClass::doSkModelStep()
{
  DiscreteTimeDerivative_Obj.setExternalInputs(&DiscreteTimeDerivative_U);
  DiscreteTimeDerivative_Obj.step();
}

void ComponentClass::terminateSkModel()
{
  DiscreteTimeDerivative_Obj.terminate();
}

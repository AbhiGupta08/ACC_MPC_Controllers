...
MODEL                = DiscreteTimeDerivative
MODULES              = DiscreteTimeDerivative_data.cpp maps_DiscreteTimeDerivative.cpp rt_cppclass_main.cpp
MAKEFILE             = DiscreteTimeDerivative.mk
...
ALT_MATLAB_BIN       = C:\PROGRA~1\MATLAB\R2024a\bin
MASTER_ANCHOR_DIR    = 
START_DIR            = D:\UWAFT\CAV\ACC Resources and MPC code\ACC_MPC_Controllers\Project Code and Supporting Files\RTMaps Code Generation Files
S_FUNCTIONS          = 
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = DiscreteTimeDerivative_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\DiscreteTimeDerivative_rtmaps_build
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\extern\include

...
#include "maps_accel_command_smoothing_saturation.h"
...
void ComponentClass::computeSkModelInputs()
{
  ...
  m_skModelInputs.emplace_back(
    ...
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &accel_command_smoothing_satur_U.JerkMaxLimms3,
    [] (const TypeID_Value mapsTypeId, const void* mapsInPtr, void *data, const
        size_t elementCount)
  {
    copyData(
  ...
  m_skModelInputs.emplace_back(
    ...
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &accel_command_smoothing_satur_U.AccelerationMinms2,
    [] (const TypeID_Value mapsTypeId, const void* mapsInPtr, void *data, const
        size_t elementCount)
  {
    copyData(
  ...
  m_skModelInputs.emplace_back(
    ...
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &accel_command_smoothing_satur_U.SetSpeedTargetms,
    [] (const TypeID_Value mapsTypeId, const void* mapsInPtr, void *data, const
        size_t elementCount)
  {
    copyData(
  ...
  m_skModelInputs.emplace_back(
    ...
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &accel_command_smoothing_satur_U.HostVelocityms,
    [] (const TypeID_Value mapsTypeId, const void* mapsInPtr, void *data, const
        size_t elementCount)
  {
    copyData(
...
void ComponentClass::computeSkModelOutputs()
{
  ...
  const ExtY_accel_command_smoothing__T &accel_command_smoothing_satur_Y =
    accel_command_smoothing_sat_Obj.getExternalOutputs();
  m_skModelOutputs.emplace_back(
    "FinalAccelerationCommandms2",
    0,
    1,
    SkTypeId::t_double,
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &accel_command_smoothing_satur_Y.FinalAccelerationCommandms2,
...
{
  accel_command_smoothing_sat_Obj.initialize();
}

void ComponentClass::doSkModelStep()
{
  accel_command_smoothing_sat_Obj.setExternalInputs
    (&accel_command_smoothing_satur_U);
  accel_command_smoothing_sat_Obj.step();
}

void ComponentClass::terminateSkModel()
{
  accel_command_smoothing_sat_Obj.terminate();
}

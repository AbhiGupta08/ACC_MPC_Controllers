...
void ComponentClass::computeSkModelOutputs()
{
  ...
  const ExtY_Add3Elements_T &Add3Elements_Y =
    Add3Elements_Obj.getExternalOutputs();
  m_skModelOutputs.emplace_back(
    "TotalDesiredAccelerationms2",
    0,
    1,
    SkTypeId::t_double,
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &Add3Elements_Y.TotalDesiredAccelerationms2,
...
{
  Add3Elements_Obj.initialize();
}

void ComponentClass::doSkModelStep()
{
  Add3Elements_Obj.setExternalInputs(&Add3Elements_U);
  Add3Elements_Obj.step();
}

void ComponentClass::terminateSkModel()
{
  Add3Elements_Obj.terminate();
}

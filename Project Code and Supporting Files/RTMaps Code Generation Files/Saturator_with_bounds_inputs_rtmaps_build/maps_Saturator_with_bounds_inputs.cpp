...
#include "maps_Saturator_with_bounds_inputs.h"
...
void ComponentClass::computeSkModelOutputs()
{
  ...
  const ExtY_Saturator_with_bounds_in_T &Saturator_with_bounds_inputs_Y =
    Saturator_with_bounds_input_Obj.getExternalOutputs();
...
{
  Saturator_with_bounds_input_Obj.initialize();
}

void ComponentClass::doSkModelStep()
{
  Saturator_with_bounds_input_Obj.setExternalInputs
    (&Saturator_with_bounds_inputs_U);
  Saturator_with_bounds_input_Obj.step();
}

void ComponentClass::terminateSkModel()
{
  Saturator_with_bounds_input_Obj.terminate();
}

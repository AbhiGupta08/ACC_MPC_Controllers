...
#include "maps_AEB_FdFwd_Deccel.h"
...
void ComponentClass::computeSkModelOutputs()
{
  ...
  const ExtY_AEB_FdFwd_Deccel_T &AEB_FdFwd_Deccel_Y =
    AEB_FdFwd_Deccel_Obj.getExternalOutputs();
  m_skModelOutputs.emplace_back(
    "AEBFeedForwardDeccelms2",
    0,
    1,
    SkTypeId::t_double,
    "real_T",
...
{
  AEB_FdFwd_Deccel_Obj.initialize();
}

void ComponentClass::doSkModelStep()
{
  AEB_FdFwd_Deccel_Obj.setExternalInputs(&AEB_FdFwd_Deccel_U);
  AEB_FdFwd_Deccel_Obj.step();
}

void ComponentClass::terminateSkModel()
{
  AEB_FdFwd_Deccel_Obj.terminate();
}

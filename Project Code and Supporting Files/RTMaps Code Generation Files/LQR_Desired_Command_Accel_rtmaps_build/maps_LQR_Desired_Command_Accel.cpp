...
#include "maps_LQR_Desired_Command_Accel.h"
...
void ComponentClass::computeSkModelOutputs()
{
  ...
  const ExtY_LQR_Desired_Command_Acce_T &LQR_Desired_Command_Accel_Y =
    LQR_Desired_Command_Accel_Obj.getExternalOutputs();
...
{
  LQR_Desired_Command_Accel_Obj.initialize();
}

void ComponentClass::doSkModelStep()
{
  LQR_Desired_Command_Accel_Obj.setExternalInputs(&LQR_Desired_Command_Accel_U);
  LQR_Desired_Command_Accel_Obj.step();
}

void ComponentClass::terminateSkModel()
{
  LQR_Desired_Command_Accel_Obj.terminate();
}

...
#include "maps_Set_Spd_Fdfwd_Deccel.h"
...
void ComponentClass::computeSkModelInputs()
{
  ...
  m_skModelInputs.emplace_back(
    ...
    &Set_Spd_Fdfwd_Deccel_U.SetSpeedTargetms,
...
void ComponentClass::computeSkModelOutputs()
{
  ...
  const ExtY_Set_Spd_Fdfwd_Deccel_T &Set_Spd_Fdfwd_Deccel_Y =
    Set_Spd_Fdfwd_Deccel_Obj.getExternalOutputs();
  m_skModelOutputs.emplace_back(
    "SetSpeedFeedForwardDeccelms2",
    0,
    1,
    SkTypeId::t_double,
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &Set_Spd_Fdfwd_Deccel_Y.SetSpeedFeedForwardDeccelms2,
  ...
  m_skModelOutputs.emplace_back(
    ...
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &Set_Spd_Fdfwd_Deccel_Y.SetSpeederrorms,
    [] (const TypeID_Value mapsTypeId, void* mapsOutPtr, const void *data, const
        size_t elementCount)
  {
    copyData(
...
{
  Set_Spd_Fdfwd_Deccel_Obj.initialize();
}

void ComponentClass::doSkModelStep()
{
  Set_Spd_Fdfwd_Deccel_Obj.setExternalInputs(&Set_Spd_Fdfwd_Deccel_U);
  Set_Spd_Fdfwd_Deccel_Obj.step();
}

void ComponentClass::terminateSkModel()
{
  Set_Spd_Fdfwd_Deccel_Obj.terminate();
}

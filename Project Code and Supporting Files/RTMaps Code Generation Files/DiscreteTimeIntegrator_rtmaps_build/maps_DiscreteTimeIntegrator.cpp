...
#include "maps_DiscreteTimeIntegrator.h"
...
void ComponentClass::computeSkModelOutputs()
{
  ...
  const ExtY_DiscreteTimeIntegrator_T &DiscreteTimeIntegrator_Y =
    DiscreteTimeIntegrator_Obj.getExternalOutputs();
...
void ComponentClass::computeSkModelProps()
{
  ...
  P_DiscreteTimeIntegrator_T &DiscreteTimeIntegrator_P =
    DiscreteTimeIntegrator_Obj.DiscreteTimeIntegrator_P;
  m_skModelParams.emplace_back(
    "DiscreteIntegrator_gainval",
    0,
    1,
    SkTypeId::t_double,
    "0.05",
...
{
  DiscreteTimeIntegrator_Obj.initialize();
}

void ComponentClass::doSkModelStep()
{
  DiscreteTimeIntegrator_Obj.setExternalInputs(&DiscreteTimeIntegrator_U);
  DiscreteTimeIntegrator_Obj.step();
}

void ComponentClass::terminateSkModel()
{
  DiscreteTimeIntegrator_Obj.terminate();
}

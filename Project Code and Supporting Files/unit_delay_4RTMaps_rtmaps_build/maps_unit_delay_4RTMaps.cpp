...
#include "maps_unit_delay_4RTMaps.h"
...
void ComponentClass::computeSkModelInputs()
{
  ...
  m_skModelInputs.emplace_back(
    ...
    &unit_delay_4RTMaps_U.unit_delay_in,
...
void ComponentClass::computeSkModelOutputs()
{
  ...
  const ExtY_unit_delay_4RTMaps_T &unit_delay_4RTMaps_Y =
    unit_delay_4RTMaps_Obj.getExternalOutputs();
  m_skModelOutputs.emplace_back(
    ...
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &unit_delay_4RTMaps_Y.unit_delay_out,
...
void ComponentClass::computeSkModelProps()
{
  ...
  P_unit_delay_4RTMaps_T &unit_delay_4RTMaps_P =
    unit_delay_4RTMaps_Obj.unit_delay_4RTMaps_P;
...
{
  unit_delay_4RTMaps_Obj.initialize();
}

void ComponentClass::doSkModelStep()
{
  unit_delay_4RTMaps_Obj.setExternalInputs(&unit_delay_4RTMaps_U);
  unit_delay_4RTMaps_Obj.step();
}

void ComponentClass::terminateSkModel()
{
  unit_delay_4RTMaps_Obj.terminate();
}

...
#include "maps_AccelSmoothingAndSaturation_4RTMaps.h"
...
void ComponentClass::computeSkModelInputs()
{
  ...
  m_skModelInputs.emplace_back(
    ...
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &AccelSmoothingAndSaturation_4_U.JerkMax,
    [] (const TypeID_Value mapsTypeId, const void* mapsInPtr, void *data, const
        size_t elementCount)
  {
    copyData(
  ...
  m_skModelInputs.emplace_back(
    ...
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &AccelSmoothingAndSaturation_4_U.DriverSetSpeed,
    [] (const TypeID_Value mapsTypeId, const void* mapsInPtr, void *data, const
        size_t elementCount)
  {
    copyData(
  ...
  m_skModelInputs.emplace_back(
    ...
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &AccelSmoothingAndSaturation_4_U.HostVelocity,
    [] (const TypeID_Value mapsTypeId, const void* mapsInPtr, void *data, const
        size_t elementCount)
  {
    copyData(
...
void ComponentClass::computeSkModelOutputs()
{
  ...
  const ExtY_AccelSmoothingAndSaturat_T &AccelSmoothingAndSaturation_4_Y =
    AccelSmoothingAndSaturation_Obj.getExternalOutputs();
  m_skModelOutputs.emplace_back(
    ...
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &AccelSmoothingAndSaturation_4_Y.u_cmd,
...
{
  AccelSmoothingAndSaturation_Obj.initialize();
}

void ComponentClass::doSkModelStep()
{
  AccelSmoothingAndSaturation_Obj.setExternalInputs
    (&AccelSmoothingAndSaturation_4_U);
  AccelSmoothingAndSaturation_Obj.step();
}

void ComponentClass::terminateSkModel()
{
  AccelSmoothingAndSaturation_Obj.terminate();
}

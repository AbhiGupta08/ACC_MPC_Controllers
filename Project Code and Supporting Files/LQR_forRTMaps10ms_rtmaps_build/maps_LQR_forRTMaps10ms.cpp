...
#include "maps_LQR_forRTMaps10ms.h"
...
void ComponentClass::computeSkModelInputs()
{
  ...
  m_skModelInputs.emplace_back(
    ...
    "real_T",
    static_cast<int>(sizeof( real_T )),
    &LQR_forRTMaps10ms_U.foll_dist_err,
    [] (const TypeID_Value mapsTypeId, const void* mapsInPtr, void *data, const
        size_t elementCount)
  {
    copyData(
...
void ComponentClass::computeSkModelOutputs()
{
  ...
  const ExtY_LQR_forRTMaps10ms_T &LQR_forRTMaps10ms_Y =
    LQR_forRTMaps10ms_Obj.getExternalOutputs();
...
ComponentClass::ComponentClass(const char* componentName,
  ...
  , m_skModelStepSize(static_cast<MAPSDelay>(1000000.0 * 0.01))
{
...
{
  LQR_forRTMaps10ms_Obj.initialize();
}

void ComponentClass::doSkModelStep()
{
  LQR_forRTMaps10ms_Obj.setExternalInputs(&LQR_forRTMaps10ms_U);
  LQR_forRTMaps10ms_Obj.step();
}

void ComponentClass::terminateSkModel()
{
  LQR_forRTMaps10ms_Obj.terminate();
}

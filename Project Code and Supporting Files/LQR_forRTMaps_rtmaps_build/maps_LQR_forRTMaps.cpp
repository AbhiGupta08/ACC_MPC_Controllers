...
void ComponentClass::computeSkModelOutputs()
{
  ...
  const ExtY_LQR_forRTMaps_T &LQR_forRTMaps_Y =
    LQR_forRTMaps_Obj.getExternalOutputs();
...
{
  LQR_forRTMaps_Obj.initialize();
}

void ComponentClass::doSkModelStep()
{
  LQR_forRTMaps_Obj.setExternalInputs(&LQR_forRTMaps_U);
  LQR_forRTMaps_Obj.step();
}

void ComponentClass::terminateSkModel()
{
  LQR_forRTMaps_Obj.terminate();
}
